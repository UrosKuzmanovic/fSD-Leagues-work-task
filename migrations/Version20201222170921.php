...
final class Version20201222170921 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE player (igracID INT AUTO_INCREMENT NOT NULL, ime VARCHAR(255) NOT NULL, prezime VARCHAR(255) NOT NULL, jmbg VARCHAR(13) NOT NULL, datum_rodj DATE NOT NULL, pozicija VARCHAR(255) NOT NULL, mestoID INT NOT NULL, klubID INT NOT NULL, INDEX IDX_BD9FBA1669A3CBE (mestoID), INDEX IDX_BD9FBA1C88BFA53 (klubID), PRIMARY KEY(igracID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE club (klubID INT AUTO_INCREMENT NOT NULL, naziv VARCHAR(255) NOT NULL, mestoID INT NOT NULL, INDEX IDX_7D5A109D669A3CBE (mestoID), PRIMARY KEY(klubID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
